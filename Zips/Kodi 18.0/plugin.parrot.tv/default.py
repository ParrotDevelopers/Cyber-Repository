...
def CATEGORIES():
   ...
   addDir3('Futurama','https://raw.githubusercontent.com/ParrotDevelopers/Parrot-TV-Kodi/main/Special/TV%20Shows/TV%20Shows/Futurama/Futurama.txt',9,'https://i.ibb.co/SBkYJ3m/Futurama.jpg','','')
   ...
   addDir3('Radio','https://raw.githubusercontent.com/ParrotDevelopers/Parrot-TV-Kodi/main/Special/Radio/Radio.txt',11,'https://i.ibb.co/J7k0ZYc/Radio.png','','')
   addDir3('Check For Updates','https://raw.githubusercontent.com/ParrotDevelopers/Parrot-TV-Kodi/main/Updates/6.0.0/CheckForUpdate.txt',12,'https://i.ibb.co/GHdh2Pm/Check-For-Updates.png','','')
...
def Radio():
   r = requests.get('https://raw.githubusercontent.com/ParrotDevelopers/Parrot-TV-Kodi/main/Special/Radio/Radio.txt')
   match = re.compile('name= (.+?) url= "(.+?)" logo= "(.+?)"').findall(r.content)
   for name,link, logo in match:
     addLink(name,link,logo,'','')
     
def Check_For_Updates():
   r = requests.get('https://raw.githubusercontent.com/ParrotDevelopers/Parrot-TV-Kodi/main/Updates/6.0.0/CheckForUpdate.txt')
   match = re.compile('name= (.+?) url= "(.+?)" logo= "(.+?)"').findall(r.content)
   for name,link, logo in match:
     addLink(name,link,logo,'','')
